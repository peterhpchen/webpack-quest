!(function (n) {
    ...
    (function (n, e) {
       ...
       */ (function () {
        var i = "Expected a function",
          ...
          Pn = -1,
          Mn = {};
        (Mn[O] = Mn[k] = Mn[I] = Mn[R] = Mn[S] = Mn[E] = Mn[
        ...
        (Nn[a] = Nn[c] = Nn[j] = Nn[A] = Nn[l] = Nn[s] = Nn[O] = Nn[k] = Nn[
          I
        ] = Nn[R] = Nn[S] = Nn[d] = Nn[_] = Nn[g] = Nn[y] = Nn[b] = Nn[w] = Nn[
          m
        ] = Nn[E] = Nn["[object Uint8ClampedArray]"] = Nn[z] = Nn[L] = !0),
          (Nn[v] = Nn[h] = Nn[x] = !1);
        var Fn = {
            "\\": "\\",
            "'": "'",
        ...
        var Ht = (function n(t) {
          ...
          function Xr(n, t, r, e) {
            ...
            r && (t = pt(t, zt(r))),
              e
                ? ((i = ht), (o = !1))
                : t.length >= 200 && ((i = Wt), (o = !1), (t = new Tr(t)));
            n: for (; ++u < f; ) {
              var l = n[u],
                s = null == r ? l : r(l);
          ...
          (Rr.templateSettings = {
            ...
            (Rr.prototype = Er.prototype),
            (Rr.prototype.constructor = Rr),
            (zr.prototype = Sr(Er.prototype)),
            (zr.prototype.constructor = zr),
            (Lr.prototype = Sr(Er.prototype)),
          ...
          function Au(n) {
            return function (t) {
              return _t(Mf(Wf(t).replace(Wn, "")), n, "");
            };
          }
          function Ou(n) {
            return function () {
          ...
          function Mu(n, t, r, e, u, i) {
            return (
              Fo(n) &&
                Fo(t) &&
                (i.set(t, n), Ee(n, t, void 0, Mu, i), i.delete(t)),
              n
            );
          }
          function Nu(n) {
          ...
          var pf = $e(function (n, t) {
              ...
              for (u && fi(t[0], t[1], u) && (e = 1); ++r < e; )
                for (var i = t[r], o = xf(i), f = -1, a = o.length; ++f < a; ) {
                  var c = o[f],
                    l = n[c];
                  (void 0 === l || (So(l, xn[c]) && !On.call(n, c))) &&
                    (n[c] = i[c]);
                }
              return n;
            }),
          ...
          return (
            ...
            (Rr.trim = function (n, t, r) {
              ...
              var e = Vt(n),
                u = Vt(t);
              return cu(e, Ct(e, u), Ut(e, u) + 1).join("");
            }),
  ...
  function (n, t, r) {
    ...
    var e = r(0),
      u = r.n(e);
    console.log(u.a.join(["Hi", "Webpack Demo"], " "));
  },
]);
