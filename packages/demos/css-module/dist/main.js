!(function (n) {
    ...
    (function (n, e) {
       ...
       */ (function () {
        ...
        (Pn[a] = Pn[c] = Pn[j] = Pn[A] = Pn[l] = Pn[s] = Pn[O] = Pn[S] = Pn[
          ...
          w
        ] = Pn[I] = Pn["[object Uint8ClampedArray]"] = Pn[C] = Pn[z] = !0),
          (Pn[v] = Pn[h] = Pn[x] = !1);
        var Fn = {
            "\\": "\\",
            "'": "'",
        ...
        var Gt = (function n(t) {
          var r,
            e = (t =
              null == t ? Vn : Gt.defaults(Vn.Object(), t, Gt.pick(Vn, Dn)))
              .Array,
            u = t.Date,
            hn = t.Error,
            pn = t.Function,
            ...
            Jt = t.clearTimeout !== Vn.clearTimeout && t.clearTimeout,
            Yt = u && u.now !== Vn.Date.now && u.now,
          ...
          function Te(n, t, r, e) {
            var u = e ? jt : xt,
              ...
              o = t.length,
              f = n;
            for (n === t && (t = gu(t)), r && (f = pt(n, Ct(r))); ++i < o; )
              for (
          ...
          function yu(n, t, r, e) {
            ...
            for (var i = -1, o = t.length; ++i < o; ) {
              ...
              void 0 === a && (a = n[f]), u ? Hr(r, f, a) : Fr(r, f, a);
            }
            return r;
          }
          function bu(n, t) {
          ...
          function ku(n) {
            return qu(function (t) {
              ...
              for (n && t.reverse(); e--; ) {
                ...
                if (u && !f && "wrapper" == Vu(o)) var f = new Cr([], !0);
              }
              for (e = f ? e : r; ++e < r; ) {
                var a = Vu((o = t[e])),
          ...
          function Ru(n, t, r, u, i, o, f, a, c, l) {
            ...
            return function g() {
              ...
              return (
                ...
                s && c < y && (b.length = c),
                this && this !== Vn && this instanceof g && (O = _ || Ou(O)),
                O.apply(A, b)
              );
            };
          }
          ...
          function zu(n, t) {
            ...
            return Nt(t) ? cu(Ht(e), 0, n).join("") : e.slice(0, n);
          }
          function Lu(n) {
                      ...
                      return function t() {
                        for (
                          var f = -1,
                            ...
                            s = e(l + a),
                            v =
                              this && this !== Vn && this instanceof t ? o : n;
                          ++c < l;
          ...
          var Oo = au(function (n, t) {
            ...
            So = Be(function (n, t) {
              return Du(n, 32, void 0, t, Ft(t, Gu(So)));
            }),
            ko = Be(function (n, t) {
              return Du(n, 64, void 0, t, Ft(t, Gu(ko)));
            }),
            Ro = qu(function (n, t) {
          ...
          return (
            ...
            (Rr.escape = function (n) {
              return (n = af(n)) && D.test(n) ? n.replace(M, Bt) : n;
            }),
            (Rr.escapeRegExp = function (n) {
              return (n = af(n)) && H.test(n) ? n.replace(K, "\\$&") : n;
            }),
            ...
            (Rr.lte = nf),
            (Rr.max = function (n) {
              return n && n.length ? ee(n, Hf, pe) : void 0;
            }),
            ...
            (Rr.min = function (n) {
              return n && n.length ? ee(n, Hf, Se) : void 0;
            }),
            ...
            (Rr.multiply = va),
            (Rr.nth = function (n, t) {
              return n && n.length ? Ce(n, ef(t)) : void 0;
            }),
            (Rr.noConflict = function () {
              return Vn._ === this && (Vn._ = In), this;
            }),
            (Rr.noop = Qf),
            (Rr.now = po),
            ...
            (Rr.unescape = function (n) {
              return (n = af(n)) && B.test(n) ? n.replace(W, Vt) : n;
            }),
  ...
  function (n, t, r) {
    ...
    document.body.appendChild(
      (function () {
        ...
        return (
          (n.innerHTML = u.a.join(["Webpack Demo", "CSS Module Config"], ": ")),
          n.classList.add(o.a.demo),
          n
        );
      })()
    );
  ...
  function (n, t, r) {
    ...
    var e = r(2),
      u = r.n(e)()(!1);
    u.push([n.i, "._2ERHem1w-faZDKDIn6SDqu {\n    color: blue;\n}", ""]),
      (u.locals = { demo: "_2ERHem1w-faZDKDIn6SDqu" }),
      (t.default = u);
  },
]);
