    ...
    (function (n, e) {
       ...
       */ (function () {
        ...
        (Nn[a] = Nn[c] = Nn[j] = Nn[A] = Nn[l] = Nn[s] = Nn[O] = Nn[k] = Nn[
          ...
          m
        ] = Nn[S] = Nn["[object Uint8ClampedArray]"] = Nn[z] = Nn[C] = !0),
          (Nn[v] = Nn[h] = Nn[x] = !1);
        var Fn = {
            "\\": "\\",
            "'": "'",
        ...
        var Ht = (function n(t) {
          var r,
            e = (t =
              null == t ? Gn : Ht.defaults(Gn.Object(), t, Ht.pick(Gn, Dn)))
              .Array,
            u = t.Date,
            hn = t.Error,
            pn = t.Function,
          ...
          function Xr(n, t, r, e) {
            ...
            r && (t = pt(t, zt(r))),
              e
                ? ((i = ht), (o = !1))
                : t.length >= 200 && ((i = Lt), (o = !1), (t = new Ur(t)));
            n: for (; ++u < f; ) {
              var l = n[u],
                s = null == r ? l : r(l);
          ...
          function Au(n) {
            return function (t) {
              return _t(Mf(Lf(t).replace(Ln, "")), n, "");
            };
          }
          function Ou(n) {
            return function () {
          ...
          function Cu(n, t) {
            ...
            return Pt(t) ? cu(Vt(e), 0, n).join("") : e.slice(0, n);
          }
          function Lu(n) {
          ...
          var Oo = au(function (n, t) {
            ...
            ko = $e(function (n, t) {
              return Du(n, 32, void 0, t, Ft(t, Hu(ko)));
            }),
            Eo = $e(function (n, t) {
              return Du(n, 64, void 0, t, Ft(t, Hu(Eo)));
            }),
            Io = qu(function (n, t) {
          ...
          function To(n) {
            return null != n && No(n.length) && !Po(n);
          }
          function Uo(n) {
            return qo(n) && To(n);
          }
          ...
          function Jo(n) {
            return "string" == typeof n || (!Lo(n) && qo(n) && he(n) == w);
          }
          function Yo(n) {
          ...
          return (
            ...
            (Ir.result = function (n, t, r) {
              ...
              for (u || ((u = 1), (n = void 0)); ++e < u; ) {
                ...
                void 0 === i && ((e = u), (i = r)), (n = Po(i) ? i.call(n) : i);
              }
              return n;
            }),
            (Ir.round = ha),
              ...
              var u,
                ...
                h =
                  ...
                  (On.call(t, "sourceURL")
                    ...
                    : "lodash.templateSources[" + ++Pn + "]") +
                  "\n";
              n.replace(v, function (t, r, e, o, f, a) {
                return (
                  e || (e = o),
                  (s += n.slice(c, a).replace(vn, Dt)),
                  r && ((u = !0), (s += "' +\n__e(" + r + ") +\n'")),
                  f && ((i = !0), (s += "';\n" + f + ";\n__p += '")),
                  e &&
                    (s += "' +\n((__t = (" + e + ")) == null ? '' : __t) +\n'"),
            ...
            (Ir.unescape = function (n) {
              return (n = af(n)) && $.test(n) ? n.replace(U, Gt) : n;
            }),
  ...
  function (n, t, r) {
    ...
    document.body.appendChild(
      (function () {
        ...
        return (
          (n.innerHTML = u.a.join(["Webpack Demo", "Config File"], ": ")), n
        );
      })()
    );
  },
